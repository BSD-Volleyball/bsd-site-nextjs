            ...
            <div className="mb-12 rounded-lg border border-border bg-muted/40 p-6">
                ...
                <ol className="grid list-decimal gap-1 pl-5 sm:grid-cols-2">
                    {[
                        [
                            "#code-of-conduct",
                            "Spectator/Player Code of Conduct"
                        ],
                        ["#overall-information", "BSD Overall Information"],
                        ["#playoffs", "BSD Overall Information — Playoffs"],
                        ["#participants", "Participants"],
                        ["#match-formats", "Match and Game Formats"],
                        ["#team-formats", "Team Formats"],
                        ["#playing-actions", "Playing Actions"],
                        ["#player-at-net", "Player at the Net"],
                        ["#service", "Service"],
                        ...
                        ["#game-delays", "Game Delays"],
                        [
                            "#exceptional-interruptions",
                            "Exceptional Game Interruptions"
                        ],
                        ["#intervals", "Intervals and Change of Courts"],
                        ["#participants-conduct", "Participants' Conduct"],
                        ["#misconduct", "Misconduct and Its Sanctions"],
                        [
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                >
                    ...
                    <div className="space-y-6 text-muted-foreground leading-relaxed">
                        ...
                        <div>
                            <h3 className="font-medium text-foreground text-xl">
                                10. Match Times and Game Lengths
                            </h3>
                            <p>
                ...
                <section id="playoffs" className="mb-12 scroll-mt-24">
                    <h2 className="mb-4 font-semibold text-2xl">
                        BSD Overall Information — Playoffs
                    </h2>
                ...
                <section id="match-formats" className="mb-12 scroll-mt-24">
                    ...
                    <div className="space-y-6 text-muted-foreground leading-relaxed">
                        <p>
                            ...
                            two-point lead is achieved (26-24; 27-25; …) with a
                            cap at 27 points.
                        </p>
                        <p>
                            If a team refuses to play after being summoned to do
                            so, it is declared in default and forfeits the first
                            game with a score of 0-25. It then has 5 minutes to
                            start the next game or same score for game 2, then 5
                            minutes to start the 3rd game or same score for game
                            3. BSD encourages teams to make every effort not to
                            forfeit and therefore encourages opponents to be
                            lenient with the allowance of subs if a forfeit is
                            imminent.
                        </p>
                        <p>
                            Before the match, the referee carries out a coin
                            toss to decide upon the first service and the sides
                            of the court in the first game. There is an
                            additional coin toss for game 3 of the match. The
                            winner of the toss chooses: EITHER the right to
                            serve or to receive the service, OR the side of the
                            court. The loser of the toss takes the remaining
                            choice.
                        </p>
                ...
                <section id="service" className="mb-12 scroll-mt-24">
                    <h2 className="mb-4 font-semibold text-2xl">Service</h2>
                ...
                <section id="attack-hit" className="mb-12 scroll-mt-24">
                    <h2 className="mb-4 font-semibold text-2xl">Attack Hit</h2>
                ...
                <section id="blocking" className="mb-12 scroll-mt-24">
                    <h2 className="mb-4 font-semibold text-2xl">Blocking</h2>
                ...
                <section id="game-delays" className="mb-12 scroll-mt-24">
                    <h2 className="mb-4 font-semibold text-2xl">Game Delays</h2>
                ...
                <section id="misconduct" className="mb-12 scroll-mt-24">
                    ...
                    <div className="space-y-6 text-muted-foreground leading-relaxed">
                        ...
                        <div>
                            <h3 className="font-medium text-foreground text-xl">
                                Misconduct After the Match Has Ended
                            </h3>
                            <p>
