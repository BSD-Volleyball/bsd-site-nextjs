                ...
                <section className="mb-10">
                    <div className="space-y-4 text-muted-foreground leading-relaxed">
                        <p>
                            ...
                            captains to form competitive teams in each division.
                            Players rotate in and out (no subbing occurs) to
                            encourage fair and equal playing time for all. Teams
                            often socialize together after matches, so it can be
                            a great way to meet new people! All matches are
                            played on Thursday evenings starting at 7:00 PM at
                            the Adventist HealthCare Fieldhouse (part of the{" "}
                            <Link
                ...
                <section className="mb-10">
                    ...
                    <div className="space-y-4 text-muted-foreground leading-relaxed">
                        <p>
                            ...
                            divisions &amp; teams in each division and the
                            number of men &amp; women per team varies each
                            season based on registrations; these will be
                            determined by the league commissioners after
                            registration closes. The league commissioners and
                            team captains will hold drafts to determine the
                            teams in each division. If there are not enough
                            captains for all of the teams in a particular
                            division, teams may be assigned by the league
                            commissioners.
                        </p>
                    </div>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <div className="space-y-4 text-muted-foreground leading-relaxed">
                        <p>
                            ...
                            parent or guardian. Players 16-17 are required to
                            have a parent or guardian present during their
                            matches.
                        </p>
                    </div>
                </section>
                ...
                <section className="mb-10">
                    <div className="rounded-lg border border-border bg-muted/50 p-6">
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            and is drafted on a team is expected to play, no
                            matter what division you are drafted in.
                        </p>
                    </div>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <div className="space-y-4 text-muted-foreground leading-relaxed">
                        <p>
                            Send a note to{" "}
                            <Link
                                href="mailto:comments@bumpsetdrink.com"
                                className="text-primary underline"
                            >
                ...
                <section className="mb-10">
                    <div className="rounded-lg border border-primary/50 bg-primary/5 p-6">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            clinics, tournaments, and any other information). It
                            is also important that you be there for the first
                            night of preseason if possible (as well as the other
                            nights)! Doing so will help captains draft you at a
                            division suitable for your skill level.
                        </p>
                    </div>
                </section>
