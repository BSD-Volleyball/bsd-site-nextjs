            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
                <section className="mb-12">
                    <p className="text-muted-foreground leading-relaxed">
                        ...
                        bring people together, and we are dedicated to ensuring
                        that everyone feels welcome and respected, regardless of
                        their background, gender identity, or gender expression.
                    </p>
                </section>
                ...
                <section className="mb-12">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        ...
                        celebrate the unique perspectives and talents that each
                        individual brings to their team.
                    </p>
                </section>
                ...
                <section className="mb-12">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        ...
                        norms. It is our firm belief that no one should be
                        excluded or disadvantaged based on their gender identity
                        or expression.
                    </p>
                </section>
                ...
                <section className="mb-12">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        ...
                        advantage. Fair play is at the core of our values, and
                        we actively work to ensure that all participants compete
                        on a level playing field. Volleyball is fun when all are
                        included and play is competitive, and we seek to strike
                        that balance.
                    </p>
                </section>
                ...
                <section className="mb-12">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        ...
                        right, but we are committed to learning and evolving. We
                        welcome feedback from our participants, supporters, and
                        the wider community. Your insights and experiences are
                        valuable, and we are dedicated to continually improving
                        our practices.
                    </p>
                </section>
                ...
                <section className="mb-12">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        ...
                        To this end, if you would like to get involved and help
                        shape the direction of BSD, please reach out to any of
